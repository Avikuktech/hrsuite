...
export function AppSidebar() {
    ...
    return (
        ...
        >
            ...
            <SidebarFooter className="p-0 hidden gap-0">
                                            ...
                                            <>
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <span className="text-xs font-bold text-white">
                                                        {window.appSettings?.formatDateTimeSimple(expireDate, false) || new Date(expireDate).toLocaleDateString(undefined, { day: '2-digit', month: 'short', year: 'numeric' })}
                                                    </span>
                                                </div>
                                                <div className="flex items-center justify-between">
